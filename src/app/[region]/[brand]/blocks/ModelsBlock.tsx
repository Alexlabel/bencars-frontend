...
const models = ["Tiggo 7L", "Tiggo 4", "Tiggo 4PRO 18 Y.E.", "Tiggo 7 PRO MAX", "Tiggo 8 PRO MAX", "Tiggo 9", "Arrizo 8"]
export const ModelsBlock : React.FC = () => {
    return (
        <div className="relative w-full">
            ...
            <div className="relative w-full flex justify-between items-center gap-4 h-[87px] rounded-[36px] px-10 bg-[var(--foreground)] overflow-x-auto">
                {models.map((model) => (
                    <div tabIndex={0} className="cursor-pointer text-[18px] text-white leading-[1.3] tracking-[0.4px] font-[600] focus:text-[var(--green)] transition-all duration-300">{model}</div>
                ))}
            </div>
            <div className="relative w-full py-8 tablet:py-10 md:py-12 lg:py-16 px-4">
                <div className="relative w-full flex flex-col gap-8">
                    <div className="flex flex-col gap-0">
                        <h1 className="font-[300] text-[28px] tablet:text-[42px] text-[var(--foreground)]">Chery Tiggo 7L</h1>
                        <p className="font-[400] text-[18px] tablet:text-[24px] leading-[1.3] text-[#636363]">Технологичный семейный кроссовер</p>
                    </div>
                    <div className="relative w-full grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">

                        <div className="relative min-h-[300px] w-full h-full rounded-[36px] overflow-hidden flex flex-col">
