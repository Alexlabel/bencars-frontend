...
export default function PromoPageSlider({slides = []} : PromPageSliderProps) {
    // ✅ Фолбэк слайдов, если пусто
    const preparedSlides: Slide[] =
        slides.length > 0
            ? slides
            : [
                { id: 1, image: "/images/bencars-header.png", title: "Промо бренд BenCars" },
                { id: 2, image: "/images/chery-header.png", title: "Лучшие предложения бренда Cherry"},
            ];
